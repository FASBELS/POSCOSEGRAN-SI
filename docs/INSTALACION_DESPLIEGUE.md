...
4. Carga `knowledge/catalogo.yaml --activar` mediante `python -m poscosegran.conocimiento.cargar` en un proceso administrativo cuya `POSCOSEGRAN_BD_URL_APP` apunte temporalmente a la credencial administrativa. No cambies la credencial del servicio API para hacerlo.
